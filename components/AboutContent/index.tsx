...
const AboutContent = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      title: "الرؤية",
      description:
        "رؤيتنا إننا نكون المنصة الرائدة في التعليم الرقمي في المنطقة العربية، ونساهم في بناء جيل واعد من المبدعين.",
            ...
            <div>
              ...
              <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
                <p className="relative pl-6">
                  ...
                  أكاديمية Eduvento بدأت سنة 2025 برؤية واضحة: إن التعليم التقني
                ...
                <p className="relative pl-6">
                  ...
                  على مدار السنين اللي فاتت، قدرنا ندرب آلاف الطلبة وساعدناهم
