              ...
              <AnimatePresence>
                {joinOpen && (
                  ...
                  >
                    ...
                    <li className="relative" onMouseEnter={() => setJoinOpen2(true)} onMouseLeave={() => setJoinOpen2(false)}>
                      <button className="w-full font-bold text-right  text-logo-blue px-6 py-3 flex items-center gap-1" onClick={() => setJoinOpen2((v) => !v)}>
                        فرص التعاون
