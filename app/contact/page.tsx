...
import { Mail, Phone, ArrowDown, MessageCircle } from 'lucide-react';
        ...
        <div className="container mx-auto py-24 md:py-32 px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="text-white drop-shadow-2xl">تواصل</span>
              <br />
              <span className="text-primary-yellow drop-shadow-2xl">معنا</span>
            </h1>
            ...
            >
              نحن هنا لمساعدتك في رحلتك التعليمية. تواصل معنا وسنكون سعداء 
              بالإجابة على جميع استفساراتك وتقديم الدعم الذي تحتاجه
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
                ...
                <span className="font-semibold text-white">اتصال فوري</span>
              </div>
              
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
                <Mail className="h-5 w-5 text-primary-yellow" />
                <span className="font-semibold text-white">رد خلال 24 ساعة</span>
              </div>
              
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
                <MessageCircle className="h-5 w-5 text-logo-blue" />
                <span className="font-semibold text-white">استشارة مجانية</span>
              </div>
            </motion.div>
